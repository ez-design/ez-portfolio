...
document.querySelector("#today2").value = d.getFullYear() + "/" + (d.getMonth() + 1) + "/" + day;
document.querySelector("#today3").value = d.getFullYear() + "/" + (d.getMonth() + 1) + "/" + day;

document.querySelector("#nextday").value = d.getFullYear() + "/" + (d.getMonth() + 1) + "/" + nextday;
document.querySelector("#nextday2").value = d.getFullYear() + "/" + (d.getMonth() + 1) + "/" + nextday;
document.querySelector("#nextday3").value = d.getFullYear() + "/" + (d.getMonth() + 1) + "/" + nextday;
